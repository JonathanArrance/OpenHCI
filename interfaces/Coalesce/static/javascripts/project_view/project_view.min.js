...
/* snapshot */ $(function(){var e=$("#snapshot_progressbar"),s=$("#snapshot_list"),a='<tr id="snapshot_placeholder"><td><p><i>This project has no snapshots</i></p></td><td></td><td></td></tr>';$(document).ready(function(){$("#volume_placeholder").length&&setVisible("#create-snapshot",!1)}),$(function(){var a=$("#snap_name"),t=$("#snap_volume"),o=$("#snap_desc"),n=$([]).add(a).add(t).add(o);$("#create-snapshot").click(function(e){e.preventDefault(),$("#snapshot-dialog-form").dialog("open")}),$("#snapshot-dialog-form").dialog({autoOpen:!1,height:350,width:235,modal:!0,resizable:!1,closeOnEscape:!0,draggable:!0,show:"fade",position:{my:"center",at:"center",of:$("#page-content")},buttons:{"Create Snapshot":function(){clearUiValidation(n);var l=checkLength(a,"Snapshot Name",3,16)&&checkLength(o,"Snapshot Name",1,80);if(l){var i=a.val(),r=t.val(),d=o.val();message.showMessage("notice","Creating new snapshot "+i),disableLinks(!0),setVisible("#create-snapshot",!1),$(e).progressbar({value:!1}),disableProgressbar(e,"snapshots",!1),$.getJSON("/create_snapshot/"+PROJECT_ID+"/"+i+"/"+r+"/"+d+"/").done(function(e){if("error"==e.status&&message.showMessage("error",e.message),"success"==e.status){message.showMessage("success",e.message);var a='<tr id="'+e.snapshot_id+'"><td id="'+e.snapshot_id+'-name-cell"><a href="/snapshot/'+e.snapshot_id+'/view/" class="disable-link disabled-link" style="color:#696969;"><span id="'+e.snapshot_id+'-name-text">'+e.snapshot_name+'</span></a></td><td id="'+e.snapshot_id+'-volume-cell"><span id="'+e.snapshot_id+'-volume-text">'+volumes.getItem(e.volume_id).name+'</span></td><td id="'+e.snapshot_id+'-actions-cell"><a href="#" class="delete-snapshot">delete</a><span> | </span><a href="#" class="create-volume-from-snapshot">create volume</a></td></tr>';s.append(a).fadeIn();var t=$("#snapshot_list tr").length;t>2&&$("#snapshot_placeholder").remove().fadeOut(),snapshots.setItem(e.snapshot_id,{id:e.snapshot_id,name:e.snapshot_name,volumeId:e.volume_id,volumeName:volumes.getItem(e.volume_id).name,value:e.snapshot_id,option:e.snapshot_name}),refreshSelect("#revert_snapshot_name",snapshots)}}).fail(function(){message.showMessage("error","Server Fault")}).always(function(){disableProgressbar(e,"snapshots",!0),setVisible("#create-snapshot",!0),disableLinks(!1),resetUiValidation(n)}),$(this).dialog("close")}}},close:function(){resetUiValidation(n)}})}),$(function(){var t,o,n;$(document).on("click",".delete-snapshot",function(e){e.preventDefault(),n=$(this).parent().parent(),t=$(n).attr("id"),o=document.getElementById(t+"-name-text"),$("div#snapshot-delete-confirm-form > p > span.snapshot-name").empty().append($(o).text()),$("#snapshot-delete-confirm-form").dialog("open")}),$("#snapshot-delete-confirm-form").dialog({autoOpen:!1,height:125,width:235,modal:!0,resizable:!1,closeOnEscape:!0,draggable:!0,show:"fade",position:{my:"center",at:"center",of:$("#page-content")},buttons:{Confirm:function(){var l=t,i=$(o).text(),r=n;message.showMessage("notice","Deleting "+i+".");var d=document.getElementById(l+"-actions-cell"),p=d.innerHTML;disableLinks(!0),disableActions("delete-snapshot",!0),$(e).progressbar({value:!1}),disableProgressbar(e,"snapshots",!1);var m=l+"-loader",c='<div class="ajax-loader" id="'+m+'"></div>';$(d).empty().fadeOut(),$(d).append(c).fadeIn(),$.getJSON("/delete_snapshot/"+PROJECT_ID+"/"+l+"/").done(function(e){if("error"==e.status&&(message.showMessage("error",e.message),$(d).empty().fadeOut(),$(d).append(p).fadeIn()),"success"==e.status){message.showMessage("success",e.message),r.fadeOut().remove();var t=$("#snapshot_list tr").length;2>t&&$(s).append(a).fadeIn(),snapshots.removeItem(l)}}).fail(function(){message.showMessage("error","Server Fault"),$(d).empty().fadeOut(),$(d).append(p).fadeIn()}).always(function(){disableProgressbar(e,"snapshots",!0),disableLinks(!1),disableActions("delete-snapshot",!1)}),$(this).dialog("close")}},close:function(){}})}),$(function(){var s,a,t,o=$("#vol_from_snap_name"),n=$("#vol_from_snap_size"),l=$("#vol_from_snap_desc"),i=$([]).add(o).add(n).add(l);$(document).on("click",".create-volume-from-snapshot",function(e){e.preventDefault(),t=$(this).parent().parent(),s=$(t).attr("id"),a=snapshots.items[s].volumeName,$("div#create-volume-from-snapshot-form > p > span.vol-from-snap-name").empty().append($(a).text()),$("#create-volume-from-snapshot-form").dialog("open")}),$("#create-volume-from-snapshot-form").dialog({autoOpen:!1,height:335,width:235,modal:!0,resizable:!1,closeOnEscape:!0,draggable:!0,show:"fade",position:{my:"center",at:"center",of:$("#page-content")},buttons:{"Create Volume":function(){clearUiValidation(i);var t=checkLength(o,"Volume Name",0,16)&&checkDuplicateName(o,volumes)&&checkSize(n,"Volume Size must be greater than 0.",1,0)&&checkLength(l,"Description",0,16);if(t){var r=o.val(),d=n.val(),p=l.val(),m=s,c=$(a).text();""==r&&(r="none"),""==p&&(p="none"),message.showMessage("notice","Cloning "+c+".");var h=document.getElementById(m+"-actions-cell"),u=h.innerHTML;disableLinks(!0),disableActions("create-volume-from-snapshot",!0),$(e).progressbar({value:!1}),disableProgressbar(e,"snapshots",!1);var v=m+"-loader",f='<div class="ajax-loader" id="'+v+'"></div>';$(h).empty().fadeOut(),$(h).append(f).fadeIn(),$.getJSON("/create_vol_from_snapshot/"+PROJECT_ID+"/"+m+"/"+d+"/"+r+"/"+p+"/").done(function(e){if("error"==e.status&&message.showMessage("error",e.message),"success"==e.status){message.showMessage("success","Volume "+r+" cloned from "+c+".");var s='<tr id="'+e.volume_id+'" class="'+e.volume_size+'"><td id="'+e.volume_id+'-name-cell"><a href="/projects/'+PROJECT_ID+"/volumes/"+e.volume_id+'/view/" class="disable-link"><span id="'+e.volume_id+'-name-text">'+e.volume_name+'</span></a></td><td id="'+e.volume_id+'-attached-cell"><span id="'+e.volume_id+'-attached-placeholder">No Attached Instances</span></td><td id="'+e.volume_id+'-actions-cell"><a href="#" class="attach-volume">attach</a><span class="volume-actions-pipe"> | </span><a href="#" class="delete-volume">delete</a></td></tr>',a=$("#volume_list tr").length;2>=a&&($("#volume_placeholder").remove().fadeOut(),setVisible("#create-snapshot",!0)),$("#volume_list").append(s).fadeIn(),volumes.setItem(e.volume_id,{size:e.volume_size,name:e.volume_name}),snapshotVolumes.setItem(e.volume_id,{value:e.volume_id,option:e.volume_name}),refreshSelect($("#snap_volume"),snapshotVolumes),updateUsedStorage(),updateStorageBar()}}).fail(function(){message.showMessage("error","Server Fault")}).always(function(){$(h).empty().fadeOut(),$(h).append(u).fadeIn(),disableProgressbar(e,"snapshots",!0),disableLinks(!1),disableActions("create-volume-from-snapshot",!1),resetUiValidation(i)}),$(this).dialog("close")}}},close:function(){}})})});
...
/* volume */ $(function(){var e=$("#vol_progressbar"),a=$("#volume_list"),s='<tr id="volume_placeholder"><td><p><i>This project has no volumes</i></p></td><td></td><td></td>/tr>';$(function(){var s=$("#volume_name"),t=$("#volume_size"),o=$("#description"),l=$("#volume_type"),n=$([]).add(s).add(t).add(o).add(l);$(document).on("click","#create-volume",function(e){e.preventDefault(),$("#volume-dialog-form").dialog("open")}),$("#volume-dialog-form").dialog({autoOpen:!1,height:445,width:235,modal:!0,resizable:!1,closeOnEscape:!0,draggable:!0,show:"fade",position:{my:"center",at:"center",of:$("#page-content")},buttons:{"Create Volume":function(){clearUiValidation(n);var i=checkLength(s,"Volume Name",3,16)&&checkDuplicateName(s,volumes)&&checkSize(t,"Volume Size must be greater than 0.",1,0)&&checkStorage(t)&&checkLength(o,"Description",0,16);if(i){var d=s.val(),r=t.val(),m=o.val(),c=l.val();""==m&&(m="none"),message.showMessage("notice","Creating new volume "+s.val()),disableLinks(!0),setVisible("#create-volume",!1),$(e).progressbar({value:!1}),disableProgressbar(e,"volumes",!1),$.getJSON("/create_volume/"+d+"/"+r+"/"+m+"/"+c+"/"+PROJECT_ID+"/").done(function(e){if("error"==e.status&&message.showMessage("error",e.message),"success"==e.status){message.showMessage("success",e.message);var s='<tr id="'+e.volume_id+'" class="'+e.volume_size+'"><td id="'+e.volume_id+'-name-cell"><a href="/projects/'+PROJECT_ID+"/volumes/"+e.volume_id+'/view/" class="disable-link disabled-link" style="color:#696969;"><span id="'+e.volume_id+'-name-text">'+e.volume_name+'</span></a></td><td id="'+e.volume_id+'-attached-cell"><span id="'+e.volume_id+'-attached-placeholder">No Attached Instance</span></td><td id="'+e.volume_id+'-actions-cell"><a href="#" class="attach-volume">attach</a><span class="volume-actions-pipe"> | </span><a href="#" class="clone-volume">clone</a><span class="volume-actions-pipe"> | </span><a href="#" class="revert-volume">revert</a><span class="volume-actions-pipe"> | </span><a href="#" class="delete-volume">delete</a></td></tr>',t=$("#volume_list tr").length;2>=t&&($("#volume_placeholder").remove().fadeOut(),setVisible("#create-snapshot",!0)),a.append(s).fadeIn(),volumes.setItem(e.volume_id,{size:e.volume_size,name:e.volume_name}),snapshotVolumes.setItem(e.volume_id,{value:e.volume_id,option:e.volume_name}),refreshSelect($("#snap_volume"),snapshotVolumes),updateUsedStorage(),updateStorageBar()}}).fail(function(){message.showMessage("error","Server Fault")}).always(function(){disableProgressbar(e,"volumes",!0),setVisible("#create-volume",!0),disableLinks(!1),resetUiValidation(n)}),$(this).dialog("close")}}},close:function(){resetUiValidation(n)}})}),$(function(){var t,o,l;$(document).on("click",".delete-volume",function(e){e.preventDefault(),l=$(this).parent().parent(),t=$(l).attr("id"),o=document.getElementById(t+"-name-text"),$("div#volume-delete-confirm-form > p > span.volume-name").empty().append($(o).text());var a=0;for(var s in snapshots.items){var n=snapshots.getItem(s).volumeId;console.log(n+" = "+t+" ?"),n==t&&a++}a>0?message.showMessage("error","Cannot delete this volume because it has "+a+" dependent snapshots."):$("#volume-delete-confirm-form").dialog("open")}),$("#volume-delete-confirm-form").dialog({autoOpen:!1,height:125,width:235,modal:!0,resizable:!1,closeOnEscape:!0,draggable:!0,show:"fade",position:{my:"center",at:"center",of:$("#page-content")},buttons:{Confirm:function(){var n=l,i=t,d=$(o).text();message.showMessage("notice","Deleting "+d+".");var r=document.getElementById(i+"-actions-cell"),m=r.innerHTML;disableLinks(!0),disableActions("delete-volume",!0),$(e).progressbar({value:!1}),disableProgressbar(e,"volumes",!1);var c=i+"-loader",u='<div class="ajax-loader" id="'+c+'"></div>';$(r).empty().fadeOut(),$(r).append(u).fadeIn(),$.getJSON("/delete_volume/"+i+"/"+PROJECT_ID+"/").done(function(e){if("error"==e.status&&(message.showMessage("error",e.message),$(r).empty().fadeOut(),$(r).append(m).fadeIn()),"success"==e.status){message.showMessage("success",e.message),n.fadeOut().remove(),volumes.removeItem(i),snapshotVolumes.removeItem(i),refreshSelect($("#snap_volume"),snapshotVolumes),updateUsedStorage(),updateStorageBar();var t=$("#volume_list tr").length;2>t&&($(a).append(s).fadeIn(),setVisible("#create-snapshot",!1))}}).fail(function(){message.showMessage("error","Server Fault"),$(r).empty().fadeOut(),$(r).append(m).fadeIn()}).always(function(){disableProgressbar(e,"volumes",!0),disableLinks(!1),disableActions("delete-volume",!1)}),$(this).dialog("close")}},close:function(){}})}),$(function(){var s,t,o,l=$("#clone_volume_name"),n=$("#description"),i=$([]).add(l).add(n);$(document).on("click",".clone-volume",function(e){e.preventDefault(),o=$(this).parent().parent(),s=$(o).attr("id"),t=document.getElementById(s+"-name-text"),$("div#volume-clone-form > p > span.volume-name").empty().append($(t).text()),$("#volume-clone-form").dialog("open")}),$("#volume-clone-form").dialog({autoOpen:!1,height:250,width:235,modal:!0,resizable:!1,closeOnEscape:!0,draggable:!0,show:"fade",position:{my:"center",at:"center",of:$("#page-content")},buttons:{Confirm:function(){var o=s,d=l.val(),r=n.val();""==d&&(d="none"),""==r&&(r="none"),message.showMessage("notice","Cloning "+$(t).text()+".");var m=document.getElementById(o+"-actions-cell"),c=m.innerHTML;disableLinks(!0),disableActions("clone-volume",!0),$(e).progressbar({value:!1}),disableProgressbar(e,"volumes",!1);var u=o+"-loader",v='<div class="ajax-loader" id="'+u+'"></div>';$(m).empty().fadeOut(),$(m).append(v).fadeIn(),$.getJSON("/create_vol_clone/"+PROJECT_ID+"/"+o+"/"+d+"/"+r+"/").done(function(e){if("error"==e.status&&message.showMessage("error",e.message),"success"==e.status){message.showMessage("success","Volume "+d+" cloned from volume "+$(t).text()+".");var s='<tr id="'+e.volume_id+'"><td id="'+e.volume_id+'-name-cell"><a href="/projects/'+PROJECT_ID+"/volumes/"+e.volume_id+'/view/" class="disable-link disabled-link" style="color:#696969;"><span id="'+e.volume_id+'-name-text">'+e.volume_name+'</span></a></td><td id="'+e.volume_id+'-attached-cell"><span id="'+e.volume_id+'-attached-placeholder">No Attached Instance</span></td><td id="'+e.volume_id+'-actions-cell"><a href="#" class="attach-volume">attach</a><span class="volume-actions-pipe"> | </span><a href="#" class="clone-volume">clone</a><span class="volume-actions-pipe"> | </span><a href="#" class="revert-volume">revert</a><span class="volume-actions-pipe"> | </span><a href="#" class="delete-volume">delete</a></td></tr>',o=$("#volume_list tr").length;2>=o&&($("#volume_placeholder").remove().fadeOut(),setVisible("#create-snapshot",!0)),a.append(s).fadeIn(),volumes.setItem(e.volume_id,{size:e.volume_size,name:e.volume_name}),snapshotVolumes.setItem(e.volume_id,{value:e.volume_id,option:e.volume_name}),refreshSelect($("#snap_volume"),snapshotVolumes),updateUsedStorage(),updateStorageBar()}}).fail(function(){message.showMessage("error","Server Fault")}).always(function(){$(m).empty().fadeOut(),$(m).append(c).fadeIn(),disableProgressbar(e,"volumes",!0),disableLinks(!1),disableActions("clone-volume",!1),resetUiValidation(i)}),$(this).dialog("close")}},close:function(){}})}),$(function(){var a,s,t;$(document).on("click",".attach-volume",function(e){e.preventDefault(),t=$(this).parent().parent(),a=$(t).attr("id"),s=document.getElementById(a+"-name-text"),$("div#volume-attach-dialog-form > p > span.volume-name").empty().append($(s).text()),$("#volume-attach-dialog-form").dialog("open")}),$("#volume-attach-dialog-form").dialog({autoOpen:!1,height:225,width:235,modal:!0,resizable:!1,closeOnEscape:!0,draggable:!0,show:"fade",position:{my:"center",at:"center",of:$("#page-content")},buttons:{"Attach Volume":function(){var o=$("#instance"),l=t,n=a,i=$(s).text(),d=instanceOpts.items[o.val()].value,r=instanceOpts.items[d].option;message.showMessage("notice","Attaching "+i+" to "+r+".");var m=document.getElementById(n+"-actions-cell"),c=m.innerHTML;disableLinks(!0),disableActions("attach-volume",!0),$(e).progressbar({value:!1}),disableProgressbar(e,"volumes",!1);var u=n+"-loader",v='<div class="ajax-loader" id="'+u+'"></div>';$(m).empty().fadeOut(),$(m).append(v).fadeIn(),$.getJSON("/attach_volume/"+PROJECT_ID+"/"+d+"/"+n+"/").done(function(e){if("error"==e.status&&(message.showMessage("error",e.message),$(m).empty().fadeOut(),$(m).append(c).fadeIn()),"success"==e.status){message.showMessage("success",e.message);var a=document.getElementById(n+"-attached-cell");$(m).empty().fadeOut(),$(a).empty().fadeOut();var s='<a href="#" class="detach-volume">detach</a><span class="volume-actions-pipe"> | </span><a href="#" class="clone-volume">clone</a><span class="volume-actions-pipe"> | </span><a href="#" class="revert-volume">revert</a>';$(m).append(s).fadeIn(),$(a).append(r).fadeIn(),l.addClass("volume-attached")}}).fail(function(){message.showMessage("error","Server Fault"),$(m).empty().fadeOut(),$(m).append(c).fadeIn()}).always(function(){disableProgressbar(e,"volumes",!0),disableLinks(!1),disableActions("attach-volume",!1)}),$(this).dialog("close")}},close:function(){}})}),$(function(){var a,s,t,o=$("#instance");$(document).on("click",".detach-volume",function(e){e.preventDefault(),t=$(this).parent().parent(),a=t.attr("id"),s=document.getElementById(a+"-name-text"),$("div#volume-detach-confirm-form > p > span.volume-name").empty().append($(s).text()),$("#volume-detach-confirm-form").dialog("open")}),$("#volume-detach-confirm-form").dialog({autoOpen:!1,height:125,width:235,modal:!0,resizable:!1,closeOnEscape:!0,draggable:!0,show:"fade",position:{my:"center",at:"center",of:$("#page-content")},buttons:{"Detach Volume":function(){var l=t,n=a,i=$(s).text(),d=o.val(),r=instanceOpts.items[d].option;message.showMessage("notice","Detaching "+i+" from "+r+".");var m=document.getElementById(n+"-actions-cell"),c=m.innerHTML;disableLinks(!0),disableActions("detach-volume",!0),$(e).progressbar({value:!1}),disableProgressbar(e,"volumes",!1);var u=n+"-loader",v='<div class="ajax-loader" id="'+u+'"></div>';$(m).empty().fadeOut(),$(m).append(v).fadeIn(),$.getJSON("/detach_volume/"+PROJECT_ID+"/"+n+"/").done(function(e){if("error"==e.status&&(message.showMessage("error",e.message),$(m).empty().fadeOut(),$(m).append(c).fadeIn()),"success"==e.status){message.showMessage("success",e.message);var a=document.getElementById(n+"-attached-cell");$(m).empty().fadeOut(),$(a).empty().fadeOut();var s='<a href="#" class="attach-volume">attach</a><span class="volume-actions-pipe"> | </span><span class="volume-actions-pipe"> | </span><a href="#" class="clone-volume">clone</a><span class="volume-actions-pipe"> | </span><a href="#" class="revert-volume">revert</a><a href="#" class="delete-volume">delete</a>';$(m).append(s).fadeIn(),$(a).append("No Attached Instance").fadeIn(),l.removeClass("volume-attached")}}).fail(function(){message.showMessage("error","Server Fault"),$(m).empty().fadeOut(),$(m).append(c).fadeIn()}).always(function(){disableProgressbar(e,"volumes",!0),disableLinks(!1),disableActions("detach-volume",!1)}),$(this).dialog("close")}},close:function(){}})}),$(function(){var s,t,o,l,n=$("#revert_snapshot_name"),i=$("#revert_volume_name"),d=$([]).add(n);$(document).on("click",".revert-volume",function(e){e.preventDefault(),o=$(this).parent().parent(),l=!!o.hasClass("volume-attached"),s=$(o).attr("id"),t=document.getElementById(s+"-name-text"),$("div#volume-revert-form > p > span.volume-name").empty().append($(t).text()),updateRevertVolumeSnapshots(s),$("#volume-revert-form").dialog("open")}),$("#volume-revert-form").dialog({autoOpen:!1,height:250,width:235,modal:!0,resizable:!1,closeOnEscape:!0,draggable:!0,show:"fade",position:{my:"center",at:"center",of:$("#page-content")},buttons:{Confirm:function(){clearUiValidation(d);var o=checkLength(i,"Volume Name",3,16)&&checkDuplicateName(i,volumes);if(o){var r=s,m=i.val(),c=n.val();message.showMessage("notice","Reverting "+$(t).text()+".");var u=document.getElementById(r+"-actions-cell"),v=u.innerHTML;disableLinks(!0),disableActions("revert-volume",!0),$(e).progressbar({value:!1}),disableProgressbar(e,"volumes",!1);var p=r+"-loader",f='<div class="ajax-loader" id="'+p+'"></div>';$(u).empty().fadeOut(),$(u).append(f).fadeIn(),$.getJSON("/revert_volume_snapshot/"+PROJECT_ID+"/"+r+"/"+m+"/"+c+"/").done(function(e){if("error"==e.status&&message.showMessage("error",e.message),"success"==e.status){message.showMessage("success",e.message);var s='<tr id="'+e.volume_info.volume_id+'" class="';l&&(s+="volume-attached"),s+='"><td id="'+e.volume_info.volume_id+'-name-cell"><a href="/projects/'+PROJECT_ID+"/volumes/"+e.volume_info.volume_id+'/view/" class="disable-link disabled-link" style="color:#696969;"><span id="'+e.volume_info.volume_id+'-name-text">'+e.volume_info.volume_name+'</span></a></td><td id="'+e.volume_info.volume_id+'-attached-cell"><span id="'+e.volume_info.volume_id+'-attached-placeholder">',s+=l?instances.items[e.attach_info.instance_id].name:"No Attached Instances",s+='</span></td><td id="'+e.volume_id+'-actions-cell">',s+=l?'<a href="#" class="detach-volume">detach</a>':'<a href="#" class="attach-volume">attach</a>',s+='<span class="volume-actions-pipe"> | </span><a href="#" class="revert-volume">revert</a><span class="volume-actions-pipe"> | </span><a href="#" class="clone-volume">clone</a><span class="volume-actions-pipe"> | </span><a href="#" class="delete-volume">delete</a></td></tr>';var t=$("#volume_list tr").length;2>=t&&($("#volume_placeholder").remove().fadeOut(),setVisible("#create-snapshot",!0)),a.append(s).fadeIn(),volumes.setItem(e.volume_id,{size:e.volume_size,name:e.volume_name}),snapshotVolumes.setItem(e.volume_id,{value:e.volume_id,option:e.volume_name}),refreshSelect($("#snap_volume"),snapshotVolumes),updateUsedStorage(),updateStorageBar()}}).fail(function(){message.showMessage("error","Server Fault")}).always(function(){$(u).empty().fadeOut(),$(u).append(v).fadeIn(),disableProgressbar(e,"volumes",!0),disableLinks(!1),disableActions("revert-volume",!1),resetUiValidation(d)}),$(this).dialog("close")}}},close:function(){}})})});