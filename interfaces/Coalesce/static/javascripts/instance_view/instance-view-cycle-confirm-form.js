$(function () {
    ...
    $("#instance-view-cycle-confirm-form").dialog({
        autoOpen: false,
        height: 125,
        width: 235,
        modal: true,
        buttons: {
            "Confirm": function () {
                ...
                messages.showMessage('notice', 'Powering Cycling');
                ...
                emptyAndAppend(status, "HARD_REBOOT");

                $.getJSON('/server/' + PROJECT_ID + '/' + SERVER_ID + '/power_cycle/')
                    .done(function (data) {
    ...
    $('#cycle-server').click(function () {
        $("#instance-view-cycle-confirm-form").dialog("open");
    });
});