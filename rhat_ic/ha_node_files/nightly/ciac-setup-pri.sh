...
for x in {'111','27017','24007','24008','24009','24010','24011','24012','24013','24014','24015','24016','24017','24018','24019','24020','24021','24022','24023','24025','24026','24027','24028','24029','34865','34866','34867','7788','7789','7790','7799','5405'}
do
...
#mount the drbd vols
mount -t xfs /dev/drbd0 /transcirrus/haresources
#mount -t xfs /dev/drbd1 /transcirrus/rabbit
...
mkdir -p /transcirrus/haresources/pgsql/data
mkdir -p /transcirrus/haresources/etc

chown -R postgres:postgres /transcirrus/haresources/pgsql/
chmod -R 700 /transcirrus/haresources/pgsql

#set up postgresql
chkconfig postgresql on
sudo -u postgres initdb -D /transcirrus/haresources/pgsql/data

mv /transcirrus/haresources/pgsql/data/pg_hba.conf /transcirrus/haresources/pgsql/data/pg_hba.conf.old
mv /transcirrus/haresources/pgsql/data/postgresql.conf /transcirrus/haresources/pgsql/data/postgresql.conf.old
wget -P /transcirrus/haresources/pgsql/data http://192.168.10.10/rhat_ic/ha_node_files/pg_hba.conf
chown postgres:postgres /transcirrus/haresources/pgsql/data/pg_hba.conf
wget -P /transcirrus/haresources/pgsql/data http://192.168.10.10/rhat_ic/ha_node_files/postgresql.conf
chown postgres:postgres /transcirrus/haresources/pgsql/data/postgresql.conf
chmod 766 /transcirrus/haresources/pgsql/data/pg_hba.conf
chmod 766 /transcirrus/haresources/pgsql/data/postgresql.conf
...
psql -U postgres -c "ALTER USER transuser WITH PASSWORD 'simpleprivatecloudsolutions';"
...
#patch python security
wget -P /root http://192.168.10.10/rhat_ic/common/gmp-6.1.0.tar.bz2
tar -xvjpf /root/gmp-6.1.0a.tar.bz2 -C /root
cd /root/gmp-6.1.0
./configure
make
make check
...
#add the clusterIP to corosync file
IP=`ip addr | grep inet | grep bond3 | awk -F" " '{print $2}' | sed -e 's/\/.*$//'`
sed -i 's/%HANODE1%/'${IP}'/g' /etc/corosync/corosync.conf
...
#add the initial cluster info for primary node
crm configure property stonith-enabled=false
crm configure property no-quorum-policy=ignore
crm configure property defaults resource-stickiness=100
crm configure property defaults timeout=120s
crm configure primitive p_data_vip IPaddr2 params ip=172.24.24.10 nic=bond1 cidr_netmask="24" op monitor interval=10s
crm configure location cli-prefer-p_data_vip p_data_vip role=Started inf: ${HOSTNAME}
crm configure primitive p_uplink_vip IPaddr2 params ip=192.168.0.2 nic=br-ex cidr_netmask="24" op monitor interval=10s
crm configure location cli-prefer-p_cluster_vip p_uplink_vip role=Started inf: ${HOSTNAME}

#get the cluster node ID
CLUST_NODE_ID=`sudo crm_node -i`
echo ${CLUST_NODE_ID} >> /etc/cluster_nodeid

#create ssh keys for clustering
ssh-keygen -t rsa -f ~/.ssh/id_rsa -N ""
cp ~/.ssh/id_rsa.pub ~/.ssh/authorized_keys

#get the new http config
mv /etc/httpd/conf/httpd.conf /etc/httpd/conf/httpd.old
wget -P /etc/httpd/conf http://192.168.10.10/rhat_ic/ha_node_files/httpd.conf
...
wget -P /etc http://192.168.10.10/rhat_ic/ha_node_files/nightly/ha_configs_nightly.tar
tar -xvf /etc/ha_configs_nightly.tar -C /etc
...
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('trans_default_id','"${TRANS_TENANT}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('service_id','"${SERVICE_TENANT}"','ALL','ALL');"
...
psql -U postgres -d transcirrus -c "INSERT INTO projects VALUES ('"${TRANS_TENANT}"', 'trans_default',NULL,NULL,NULL,NULL,'ALL','172.24.24.10',NULL,NULL);"
...
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('member_role_id','"${MEMBER_ROLE}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('def_member_role_id','"${DEF_MEM_ROLE}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('admin_token','"${ADMIN_TOKEN}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('hosted_flavor','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('api_ip','"${CONTROLLER_PUBLIC_ADDRESS}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('admin_role_id','"${ADMIN_ROLE}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('admin_api_ip','"${CONTROLLER_PUBLIC_ADDRESS}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('int_api_ip','"${CONTROLLER_PUBLIC_ADDRESS}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('admin_pass_set','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('first_time_boot','1','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('cloud_name','TransCirrusCloud','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('single_node','2','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('transcirrus_db','172.24.24.10','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('tran_db_user','transuser','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('tran_db_pass','simpleprivatecloudsolutions','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('tran_db_name','transcirrus','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('tran_db_port','5432','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('cloud_controller_id','"${NODEID}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('os_db','172.24.24.10','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('vm_ip_min','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('vm_ip_max','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('os_db_user','transuser','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('os_db_pass','simpleprivatecloudsolutions','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('os_db_port','5432','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('hosted_os','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('cloud_controller','"${HOSTNAME}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('uplink_ip','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('default_pub_net_id','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('default_pub_subnet_id','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('software_version','alpo.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('uplink_subnet','255.255.255.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('uplink_gateway','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('uplink_dns','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('uplink_domain_name','localdomain','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('mgmt_subnet','255.255.255.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('mgmt_dns','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('mgmt_domain_name','localdomain','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('spindle_node','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('hybrid_node','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('uplink_vip','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('cluster_name','transcirrus','ALL','ALL');"
...
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('member_role_id','"${MEMBER_ROLE}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('def_member_role_id','"${DEF_MEM_ROLE}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('admin_token','"${ADMIN_TOKEN}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('hosted_flavor','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('api_ip','"${CONTROLLER_PUBLIC_ADDRESS}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('admin_role_id','"${ADMIN_ROLE}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('admin_api_ip','"${CONTROLLER_PUBLIC_ADDRESS}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('int_api_ip','"${CONTROLLER_PUBLIC_ADDRESS}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('admin_pass_set','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('first_time_boot','1','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('cloud_name','TransCirrusCloud','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('single_node','2','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('transcirrus_db','172.24.24.10','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('tran_db_user','transuser','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('tran_db_pass','simpleprivatecloudsolutions','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('tran_db_name','transcirrus','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('tran_db_port','5432','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('cloud_controller_id','"${NODEID}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('os_db','172.24.24.10','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('vm_ip_min','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('vm_ip_max','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('os_db_user','transuser','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('os_db_pass','simpleprivatecloudsolutions','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('os_db_port','5432','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('hosted_os','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('cloud_controller','"${HOSTNAME}"','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('uplink_vip','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('default_pub_net_id','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('default_pub_subnet_id','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('uplink_subnet','255.255.255.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('uplink_gateway','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('uplink_dns','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('uplink_domain_name','localdomain','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('mgmt_subnet','255.255.255.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('mgmt_dns','0.0.0.0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('mgmt_domain_name','localdomain','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('spindle_node','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('hybrid_node','0','ALL','ALL');"
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('cluster_name','transcirrus','ALL','ALL');"
...
echo "NODE_CLUSTER_ID='"${CLUST_NODE_ID}"'" >> /usr/local/lib/python2.7/transcirrus/common/config.py
...
#echo "TRANSCIRRUS_DB='"${DATA}"'" >> /usr/local/lib/python2.7/transcirrus/common/config.py
...
echo "DATA_IP='172.24.24.10'" >> /usr/local/lib/python2.7/transcirrus/common/config.py
...
#gluster volume create cinder-volume-ssd ${DATA}:/data/gluster'-'${HOSTNAME}/cinder-volume-ssd
...
#gluster volume create cinder-volume-spindle ${DATA}:/data/gluster-spindle'-'${HOSTNAME}/cinder-volume-spindle
...
#gluster volume create instances ${DATA}:/data/gluster'-'${HOSTNAME}/instances
#gluster volume start instances
#mount -t glusterfs ${DATA}:/instances /var/lib/nova/instances
...
#echo ''${DATA}':/instances /var/lib/nova/instances glusterfs defaults,_netdev 0 0' >> /etc/fstab
#chown -R nova:nova /var/lib/nova/instances
#echo 'chown -R nova:nova /var/lib/nova/instances' >> /etc/rc.local

#gluster volume create glance ${DATA}:/data/gluster-spindle'-'${HOSTNAME}/glance
#gluster volume start glance
#mount -t glusterfs ${DATA}:/glance /var/lib/glance
...
#echo ''${DATA}':/glance /var/lib/glance glusterfs defaults,_netdev 0 0' >> /etc/fstab
...
chkconfig --levels 235 zero_connect off
...
#download the resources agents
mkdir -p /usr/lib/ocf/resource.d/openstack
wget -P /usr/lib/ocf/resource.d/openstack http://192.168.10.10/rhat_ic/ha_node_files/agents/ra.tar
tar -xvf /usr/lib/ocf/resource.d/openstack/ra.tar -C /usr/lib/ocf/resource.d/openstack/
...
#turn off bond1 - data bond
sed -i 's/ONBOOT="yes"/ONBOOT="no"/' /etc/sysconfig/network-scripts/ifcfg-bond1
