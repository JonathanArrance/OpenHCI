...
#start drbd
drbdadm -- --overwrite-data-of-peer primary haresource
...
wget -P /transcirrus/haresources/etc/sysconfig http://192.168.10.10/rhat_ic/ciac_files/dhcpd
wget -P /transcirrus/haresources/etc/dhcp http://192.168.10.10/rhat_ic/ciac_files/dhcpd.conf
#dhcp on by default
...
wget -P /transcirrus/haresources/etc http://192.168.10.10/rhat_ic/ha_node_files/mongodb.conf
chmod 644 /transcirrus/haresources/etc/mongodb.conf
ln -s /transcirrus/haresources/etc/mongodb.conf /etc/mongodb.conf
...
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('node_type','ha','"${HOSTNAME}"');"
...
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('tran_db_pass','simpleprivatecloudsolutions','"${HOSTNAME}"');"
...
psql -U postgres -d transcirrus -c "INSERT INTO trans_system_settings VALUES ('os_db_pass','simpleprivatecloudsolutions','"${HOSTNAME}"');"
...
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('node_type','ha','"${HOSTNAME}"');"
...
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('tran_db_pass','simpleprivatecloudsolutions','"${HOSTNAME}"');"
...
psql -U postgres -d transcirrus -c "INSERT INTO factory_defaults VALUES ('os_db_pass','simpleprivatecloudsolutions','"${HOSTNAME}"');"
...
for x in {'111','24007','24008','24009','24010','24011','24012','24013','24014','24015','24016','24017','24018','24019','24020','24021','24022','24023','24025','24026','24027','24028','24029','34865','34866','34867','7788','5404'}
do
