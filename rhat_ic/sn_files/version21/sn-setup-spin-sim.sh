...
wget -P /etc http://192.168.10.10/rhat/sn_files/version21/sn_configs_spindle_21.tar
...
wget -P /usr/local/lib/python2.7/transcirrus http://192.168.10.10/builds/rhat/version_21_release
sleep 1
