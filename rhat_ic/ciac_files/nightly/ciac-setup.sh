...
#get qemu-kvm
#yum install -y http://192.168.10.10/rhat_ic/kvm/qemu-img-rhev-0.12.1.2-2.448.el6.x86_64.rpm
#yum install -y http://192.168.10.10/rhat_ic/kvm/qemu-kvm-rhev-0.12.1.2-2.448.el6.x86_64.rpm
#yum install -y http://192.168.10.10/rhat_ic/kvm/qemu-kvm-rhev-tools-0.12.1.2-2.448.el6.x86_64.rpm
