...
#ADMIN_TOKEN="simpleprivatecloudsolutions09283"
...
#rabbitmqctl add_user transuser simpleprivatecloudsolutions
...
wget -P /etc http://192.168.10.10/rhat_ic/ciac_files/version2_4/os_configs.tar
...
wget -P /usr/local/lib/python2.7/transcirrus http://192.168.10.10/builds/rhat_ic/version_2_4_release
sleep 1
tar -xvf /usr/local/lib/python2.7/transcirrus/version_2_4_release -C /usr/local/lib/python2.7/transcirrus
...
rm /usr/local/lib/python2.7/transcirrus/version_2_4_release
...
echo "MASTER_PWD='simpleprivatecloudsolutions'" >> /usr/local/lib/python2.7/transcirrus/common/config.py
