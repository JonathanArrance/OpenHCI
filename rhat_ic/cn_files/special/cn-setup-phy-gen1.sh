...
wget -P /etc http://192.168.10.10/rhat_ic/cn_files/special/cn_configs_v23.tar
tar -xvf /etc/cn_configs_v23.tar -C /etc
...
wget -P /usr/local/lib/python2.7/transcirrus http://192.168.10.10/builds/rhat_ic/version_232_release
sleep 1
tar -xvf /usr/local/lib/python2.7/transcirrus/version_232_release -C /usr/local/lib/python2.7/transcirrus
...
rm /usr/local/lib/python2.7/transcirrus/version_232_release
...
mkdir Ðp /mnt/nfs-vol/cinder-volume
