...
def build_project(auth_dict, project_dict):
    ...
    try:
        ...
        logger.sys_error("Couldn't create a project, %e") %(str(e))
    ...
    try:
        ...
        logger.sys_error("Couldn't create a power user for the project, %e") %(str(e))
    ...
    try:
        ...
        logger.sys_error("Couldn't create a private network, %e") %(str(e))
    ...
    try:
        ...
        logger.sys_error("Couldn't create a subnet, %e") %(str(e))
    ...
    try:
        ...
        logger.sys_error("Couldn't create a security group, %e") %(str(e))
    ...
    try:
        ...
        logger.sys_error("Couldn't create security keys, %e") %(str(e))
    ...
    try:
        ...
        logger.sys_error("Couldn't create a router, %e") %(str(e))
    ...
    try:
        ...
        logger.sys_error("Couldn't create a router internal interface, %e") %(str(e))
    ...
    try:
        ...
        logger.sys_error("Couldn't create a router gateway, %e") %(str(e))
