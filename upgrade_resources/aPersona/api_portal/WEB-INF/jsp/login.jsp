...
<div style="height:100%; min-height:100%; position:relative;">
	...
	<div class="boxLayout" style="width:450px; height:250px;">
          ...
          <form name="kvAdminLoginForm" action="authUser.ap" method="post">
                  ...
                  <table border="0" cellspacing="2" cellpadding="2" width="100%" style="background-color: rgb(255,255,255); height: 84px;">
                    <tr style="height: 22px;">
                      ...
                      <td width="184" id="Cell16">
                        <p style="margin-bottom: 0px;"><input required type="email" name="userEmail" size="23" 
                    ...
                    <tr style="height: 22px;">
                      ...
                      <td id="Cell17">
                        <p style="margin-bottom: 0px;"><input required type="password" name="userPwd" size="23" style="white-space: pre; width: 180px;"></p>
                      </td>
                    </tr>
              ...
              <div id="Text130" class="nof-positioning TextObject" style="width: 200px; margin-top: 2px; margin-left: 127px; ">
                <p style="text-align: center; margin-bottom: 0px;"><a href="forgotPassword.ap">
                		<span style="font-size: 10px; color: rgb(0,102,255);">Reset your aPersona ASM Password?</span></a></p>
              </div>
              <div id="Text130" class="nof-positioning TextObject" style="width: 250px; margin-top: 2px; margin-left: 127px; ">
                <p style="text-align: center; margin-bottom: 0px;"><a href="newRegistration.ap">
                		<span style="font-size: 10px; color: rgb(0,102,255);">Complete the "new admin" registration process</span></a></p>
              </div>
          </form>
         </div>		
	</div>
